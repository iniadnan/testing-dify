...
const Welcome: FC<IWelcomeProps> = ({
  ...
  const renderHeader = () => {
    return (
      ...
      <div className='fixed md:absolute top-12 md:top-0 left-0 right-0 flex items-center justify-between mobile:h-12 tablet:h-16 px-8 bg-[#1E222C] z-10'>
        ...
        {!hasSetInputs && (
          <div className='mt-4 flex justify-between items-center h-8 text-xs text-gray-400'>
            ...
            <a className='flex items-center pr-3 space-x-3' href="https://dify.ai/" target="_blank">
              <span className='uppercase text-[#DEDEDE]'>{t('app.chat.powerBy')}</span>
              {/* CHANGE: WELCOME HEADER POWERED BY DIFY */}
              {/* <FootLogo /> */}
            </a>
          </div>
        )}
