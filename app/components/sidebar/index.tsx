...
const Sidebar: FC<ISidebarProps> = ({
  ...
  return (
    ...
    <div className="shrink-0 flex flex-col overflow-y-auto bg-[#1E222C] pc:w-[244px] tablet:w-[192px] mobile:w-[240px]  border-r border-gray-200 tablet:h-[calc(100vh_-_3rem)] mobile:h-screen">
      {/* CHANGE: SIDEBAR HEADER BACKGROUND COLOR */}
      ...
      {/* CHANGE: SIDEBAR BODY BACKGROUND COLOR */}
      {/* <nav className="mt-4 flex-1 space-y-1 bg-white p-4 !pt-0"> */}
      <nav className="mt-4 flex-1 space-y-1 bg-[#1E222C] p-4 !pt-0">
        {list.map((item) => {
